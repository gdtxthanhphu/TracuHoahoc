...
# --- 1. CẤU HÌNH TRANG & CSS CHUẨN (FIX LỖI MÀU SẮC) ---
st.set_page_config(page_title="Hóa Học Online", page_icon="🎓", layout="wide")

# Hàm CSS tùy chỉnh mạnh mẽ hơn để ép màu chữ
def local_css():
    st.markdown("""
    <style>
        /* 1. Ép nền trang màu xám xanh nhẹ (giống web học tập) */
        .stApp {
            background-color: #F0F4F8 !important;
        }
        
        /* 2. Ép TOÀN BỘ chữ thành màu đen/xám đậm (Khắc phục lỗi chữ trắng) */
        h1, h2, h3, h4, h5, h6, p, span, div, label {
            color: #1E293B !important; /* Màu xám đen đậm */
            font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
        }
        
        /* 3. Sidebar: Nền trắng, chữ đen */
        ...
        /* 4. Tạo Style cho các thẻ Card (Dashboard) */
        .css-card {
        ...
        .stButton>button {
            background-color: #2563EB !important; /* Xanh dương đậm */
...
if app_mode == "🏠 Trang chủ":
    ...
    with col1:
        ...
        <div class="css-card">
            <h1>🔍</h1>
            <h3>Tra Cứu Chất</h3>
            <p>Truy cập dữ liệu của 100 triệu chất hóa học. Xem cấu trúc 3D, Phổ IR/MS từ NIST.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="css-card">
            <h1>⚖️</h1>
            <h3>Cân Bằng PT</h3>
            <p>Công cụ cân bằng phản ứng Oxi hóa - Khử siêu tốc. Hỗ trợ các phương trình phức tạp.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="css-card">
            <h1>🧮</h1>
            <h3>Tiện Ích</h3>
            <p>Tính phân tử khối (M), tra cứu Bảng tuần hoàn, xem cấu hình electron và độ âm điện.</p>
        </div>
        """, unsafe_allow_html=True)
    
    st.markdown("<br><br>", unsafe_allow_html=True)
    st.success("👉 Hãy chọn chức năng ở menu bên trái để bắt đầu làm việc!")

# --- TRA CỨU ---
elif app_mode == "🔍 Tra cứu & Cấu trúc":
    st.markdown("## 🧪 **Thư Viện Hóa Chất Số**")
    
    # Container trắng bao quanh vùng tìm kiếm
    with st.container():
